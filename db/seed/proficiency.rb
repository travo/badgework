module Seed
  class Proficiency
    ...
    def self.seed
      ...
      proficiency = Target.create(title: 'Abseiling', description: 'To gain the Abseiling badge you must complete, with your Patrol or other Scouts and the appropriate qualified persons, all of the requirements for A, B and C. Participants must have attained the age of 11 years. Abseil must be single pitch, no greater than 50 metres. All abseiling activities to comply with State safety regulations.')
      activity = Activity.create(:targets => [proficiency], title: 'Demonstrate', description: 'Prior to abseil, demonstrate precautions applicable to abseiling including:')
      ...
      activity = Activity.create(:targets => [proficiency], title: 'Skill', description: 'Demonstrate thorough knowledge of:')
      ...
      activity = Activity.create(:targets => [proficiency], title: 'Activity')
      Task.create(activity: activity, order: 1, description: 'Undertake five abseils.')


      proficiency = Target.create(title: 'Agriculture', description: 'To gain the Agriculture badge you must complete one task from each of A, B and C. Show that you have gained a broad understanding of agriculture and a more detailed knowledge of a specific interest in a field related to agriculture. Range: farming, gardening, fishery, forestry, resource management, pesticide and fertilizer usage')
      activity = Activity.create(:targets => [proficiency], title: 'Investigate', requirement: 1)
      ...
      activity = Activity.create(:targets => [proficiency], title: 'Skill', requirement: 1)
      ...
      activity = Activity.create(:targets => [proficiency], title: 'Activity', requirement: 1)
      ...
      proficiency = Target.create(title: 'Astronomer', description: 'To gain the Astronomer badge you must complete one task from each of A, B and C. Show you have an interest in, have practised and have an improved proficiency in Astronomy.')
      activity = Activity.create(:targets => [proficiency], title: 'Investigate', requirement: 1)
      ...
      proficiency = Target.create(title: 'Bushcraft', description: 'To gain the Bushcraft badge you must complete one task from section A, two tasks from section B, and three tasks from section C. Show you have an interest in, have practised and have an improved proficiency in some form of Bushcraft.')
      activity = Activity.create(:targets => [proficiency], title: 'Investigate', requirement: 1)
      ...
      activity = Activity.create(:targets => [proficiency], title: 'Skill', requirement: 2)
      ...
      activity = Activity.create(:targets => [proficiency], title: 'Activity', requirement: 3)
      ...
      proficiency = Target.create(title: 'Caving', description: 'To complete the Caving badge you must complete, with your Patrol or other Scouts and the appropriate qualified persons, all of the requirements for A, B and C. Participants must have attained the age of 11 years. Caves must be considered horizontal or non-technical, and must not require the use of ladders or abseiling. Duration of underground stay must not exceed 4 hours consecutively. All caving activities are to comply to State safety regulations.')
      activity = Activity.create(:targets => [proficiency], title: 'Demonstrate', description: 'Prior to caving, demonstrate precautions applicable to caving including:')
      ...
      activity = Activity.create(:targets => [proficiency], title: 'Skill', description: 'Demonstrate knowledge of:')
      Task.create(activity: activity, order: 1, description: 'tape knot, including tie offs')
      Task.create(activity: activity, order: 2, description: 'figure 8 on a bight')
      Task.create(activity: activity, order: 3, description: 'the correct fitting of a harness')
      ...
      proficiency = Target.create(title: 'Collector', description: 'To gain the Collector badge you must own and develop a collection for at least four months and complete one task from each of A, B and C. Show that you have an interest in, have practised and/or have an improved proficiency in collecting. Range: Anything that can be collected can qualify for this badge:, e.g. stamps, signatures, coins, bottles, cards etc.')
      activity = Activity.create(:targets => [proficiency], title: 'Investigate', requirement: 1)
      ...
      proficiency = Target.create(title: 'Commerce', description: 'To gain the Commerce badge you must complete one task from each of A, B and C. Show you have an interest in, have learnt about and have an improved proficiency in some form of commerce.')
      activity = Activity.create(:targets => [proficiency], title: 'Investigate', requirement: 1)
      ...
      proficiency = Target.create(title: 'Cultural Heritage', description: 'To gain the Cultural Heritage badge you must complete one task from each of A, B and C. Show you have an interest in, have learnt about and have improved your knowledge in some aspects of the past, present and future. Range: history, religion, human race, politics, native culture and present society.')
      activity = Activity.create(:targets => [proficiency], title: 'Investigate', requirement: 1)
      ...
      proficiency = Target.create(title: 'Crime Prevention', description: 'To gain the Crime Prevention badge you must complete one task from each of A, B and C.')
      activity = Activity.create(:targets => [proficiency], title: 'Investigate', requirement: 1)
      ...
      proficiency = Target.create(title: 'Community', description: 'To gain the Community badge you must complete all the requirements for A, B and C. Range: Meals on Wheels, charity food collection and distribution, service clubs, charitable organisations etc.')
      activity = Activity.create(:targets => [proficiency], title: 'Investigate', requirement: 1)
      ...
      proficiency = Target.create(title: 'Communication', description: 'To gain the Communication badge you must complete one task from each of A, B and C. Show you have an interest in, have learnt about and have an improved proficiency in some form of communication.')
      activity = Activity.create(:targets => [proficiency], title: 'Investigate', requirement: 1)
      ...
      proficiency = Target.create(title: 'Fire Awareness', description: 'To gain the Fire Awareness badge you must complete one task from each of A, B and C. Show you have an interest in, have learnt about and have improved your knowledge in fire awareness (fire safety, fire fighting, fire and the environment).')
      activity = Activity.create(:targets => [proficiency], title: 'Investigate', requirement: 1)
      ...
      activity = Activity.create(:targets => [proficiency], title: 'Skill', description: 'As a member of a Patrol, or individually', requirement: 1)
      ...
      activity = Activity.create(:targets => [proficiency], title: 'Activity', description: 'Carry out the following: (* SIMULATE only)', requirement: 1)
      ...
      proficiency = Target.create(title: 'Literary Arts', description: 'To gain the Literary Arts badge you must complete one task from each of A, B and C. Show you have an interest in, have learnt about and have improved your knowledge in literary arts. Range: writing, poetry, and public speaking.')
      activity = Activity.create(:targets => [proficiency], title: 'Investigate', requirement: 1)
      ...
      proficiency = Target.create(title: 'Modeller', description: 'To gain the Modeller badge you must complete one task from each of A, B and C. Show that you have an interest and an improved proficiency in creating models and constructional projects. Range: plastics, glasswork, plaster, metal work, wood and fibreglass')
      activity = Activity.create(:targets => [proficiency], title: 'Investigate', requirement: 1)
      ...
      proficiency = Target.create(title: 'Multi Media', description: 'To gain the Multi Media badge you must complete one task from each of A, B and C. Show that you have an interest in, have practised and have an improved efficiency in the field of multi media. Range: pictures, animated graphics, news, websites, PowerPoint and computer programming.')
      activity = Activity.create(:targets => [proficiency], title: 'Investigate', requirement: 1)
      ...
      proficiency = Target.create(title: 'Outdoor', description: 'To gain the Outdoor badge you must complete one task from each of A, B and C. This badge is completed in the outdoors. Show that you have improved your existing skills and learned new skills in outdoor activities. Range: camping, hiking, canoeing, sailing, and other outdoor activities of Scouts choice.')
      activity = Activity.create(:targets => [proficiency], title: 'Investigate', requirement: 1)
      ...
      activity = Activity.create(:targets => [proficiency], title: 'Activity', description: 'Over an appropriate period of time, undertake an activity that extends your current level of understanding or ability in your chosen area. Some examples:', requirement: 1)
      ...
      proficiency = Target.create(title: 'Performing Arts', description: 'To gain the Performing Arts badge you must complete one task from each of A, B and C. Range: those areas of performance and entertainment not covered by the Music or Entertainer badges such areas as production, direction, stage design, lighting, sound, script writing, costume design.')
      activity = Activity.create(:targets => [proficiency], title: 'Investigate', requirement: 1)
      ...
      proficiency = Target.create(title: 'Technology', description: 'To gain the Technology badge you must complete one task from each of A, B and C. Range: all areas of technology not covered in the Information Technology badge such as robotics, vehicle electronics, mechanical devices, radio and tracking devices.')
      activity = Activity.create(:targets => [proficiency], title: 'Investigate', description: 'Find out the history and development of one of the following subjects:', requirement: 1)
      ...
      proficiency = Target.create(title: 'Top Rope Climbing', description: 'To complete the Top Rope Climbing badge you must complete, with your Patrol or other Scouts and the appropriate qualified persons, all of the requirements for A, B and C. Participants must have attained the age of 11 years. Climb must be single pitch no greater than 15 metres. All top rope activities to comply with State safety regulations.')
      activity = Activity.create(:targets => [proficiency], title: 'Investigate', description: 'Prior to climb, demonstrate knowledge of precautions applicable to top rope climbing including:')
      Task.create(activity: activity, order: 1, description: 'approaching cliffs')
      Task.create(activity: activity, order: 2, description: 'safe distance to cliff edge')
      Task.create(activity: activity, order: 3, description: 'the need to restrain loose hair and clothing')
      ...
      activity = Activity.create(:targets => [proficiency], title: 'Skill', description: 'Demonstrate knowledge of the following:')
      Task.create(activity: activity, order: 1, description: 'tape knot, including tie offs')
      Task.create(activity: activity, order: 2, description: 'figure 8 on a bight')
      Task.create(activity: activity, order: 3, description: 'the correct fitting of a harness')
