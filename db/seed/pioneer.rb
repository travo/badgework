module Seed
  class Pioneer
    ...
    def self.seed
      ...
      activity = Activity.create(:awards => [airactivities], title: 'Visit a Scout Air Activities Centre and/or Aerodrome')
      ...
      activity = Activity.create(:awards => [airactivities], title: 'Construction (using a kit is permitted)')
      ...
      activity = Activity.create(:awards => [environment], title: 'Land Care Badge')
      ...
      activity = Activity.create(:awards => [wateractivites], title: 'Canoeing', description: 'In an approved canoe, with the assistance of an Adventurer Level Scout who has appropriate qualifications, complete the following:')
      ...
      activity = Activity.create(:awards => [wateractivites], title: 'Rowing', description: 'In an approved rowing boat, with the assistance of an Adventurer Level Scout who has appropriate qualifications, complete the following:')
      ...
      activity = Activity.create(:awards => [wateractivites], title: 'Sailing', description: 'In an approved sailing boat, with the assistance of an Adventurer Level Scout who has appropriate qualifications, complete the following:')
