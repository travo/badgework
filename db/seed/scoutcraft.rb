module Seed
  class Scoutcraft
    ...
    def self.seed
      ...
      membership = Target.create(title: 'World Scout Badge', description: 'As a new member to the Scout Movement, once you have completed the tasks below, you will be invested as a Scout, become a full member of your Patrol and be awarded the World Scout Badge.')
      scout_link = Target.create(title: 'Scout Link Badge', description: 'You Patrol Leader and Scout Leader jointly carry out the training and testing for this badge.')
      scoutcraft = Target.create(title: 'The Scoutcraft Badge', description: 'The Scoutcraft Badge is the first badge completed by every new Scout. The Scoutcraft Badge is earned within four to six weeks of your entry to the Troop. Your Patrol Leader and the Scout Leader jointly carry out the training and testing for this badge.')

      activity = Activity.create(:targets => [membership, scout_link], title: 'Attend four Scout Meetings or Activities')
      ...
      activity = Activity.create(:targets => [membership, scout_link, scoutcraft], title: 'During talks with your Scout Leaders:')
      ...
      activity = Activity.create(:targets => [membership, scout_link], title: 'Participate with some Scouts')
      Task.create(activity: activity, order: 1, description: 'I took part in an activity with some Scouts')

      activity = Activity.create(:targets => [scoutcraft, scout_link], title: 'With your Patrol, learn and demonstrate how to tie:')
      ...
      activity = Activity.create(:targets => [scoutcraft, scout_link], title: 'With your Patrol Leader or Scout Leader:')
      ...
      activity = Activity.create(:targets => [scoutcraft, scout_link], title: 'Emergencies.')
      ...
      activity = Activity.create(:targets => [scoutcraft], title: 'The Patrol System')
