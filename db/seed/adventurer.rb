module Seed
  class Adventurer
    ...
    def self.seed
      ...
      adventurer = Target.create(title: 'Adventurer Badge')
      patrol     = Target.create(title: 'Adventurer Patrol Activity')
      cord       = Target.create(title: 'Adventurer Cord')

      campcraft      = Target.create(title: 'Adventurer Campcraft', description: '')
      citizenship    = Target.create(title: 'Adventurer Citizenship', description: 'To achieve the Adventurer Citizenship Target, the Scout must complete all the requirements for No’s 1 to 4, together with any three of the remaining five parts.', requirement: 7)

      airactivities  = Target.create(title: 'Adventurer Air Activities', description: '', requirement: 6)
      construction   = Target.create(title: 'Adventurer Construction', description: '')
      emergencies    = Target.create(title: 'Adventurer Emergencies', description: '')
      environment    = Target.create(title: 'Adventurer Environment', description: '', requirement: 3)
      wateractivites = Target.create(title: 'Adventurer Water Activities', description: '', requirement: 4)
      watersafety    = Target.create(title: 'Adventurer Water Safety', description: '')
      ...
      activity = Activity.create(:targets => [campcraft], title: 'Cooking', requirement: 5)
      ...
      activity = Activity.create(:targets => [campcraft], title: 'Camp activity', requirement: 3)
      ...
      activity = Activity.create(:targets => [citizenship], title: 'Values')
      ...
      activity = Activity.create(:targets => [citizenship], title: 'First aid')
      ...
      activity = Activity.create(:targets => [citizenship], title: 'Good turn', requirement: 1)
      ...
      activity = Activity.create(:targets => [citizenship], title: 'Heritage', requirement: 1)
      ...
      activity = Activity.create(:targets => [citizenship], title: 'Activity', requirement: 2)
      ...
      activity = Activity.create(:targets => [airactivities], title: 'Activity', description: 'Arrange to visit a Scout or Air Activity Centre and/or aerodrome.')
      ...
      activity = Activity.create(:targets => [airactivities], title: 'Light Aircrift Familiarisation', requirement: 5, required: false)
      ...
      activity = Activity.create(:targets => [airactivities], title: 'Glider Familiarisation', requirement: 5, required: false)
      ...
      activity = Activity.create(:targets => [airactivities], title: 'Aeromodeling', description: 'Construct two models selected from the following classifications (use of kit permitted). The models shall have the minimum flight times listed below:', required: false)
      ...
      activity = Activity.create(:targets => [construction], title: 'Knots and structure')
      ...
      activity = Activity.create(:targets => [construction], title: 'Organisation and management', description: 'Plan and lead your Patrol or other Scouts in the completion of two of the following major projects:', requirement: 2)
      ...
      activity = Activity.create(:targets => [emergencies], title: 'Mock Emergencies')
      ...
      activity = Activity.create(:targets => [environment], title: 'Nature', description: 'Identify where a waterway, or wetland, or river system in a local/national region has been environmentally effected by such as salinity, soil erosion, pollution, introduced species animal, fish or plant.')
      ...
      activity = Activity.create(:targets => [environment], title: 'Nature', description: 'Participate in a study of a local, national or international:')
      ...
      activity = Activity.create(:targets => [environment], title: 'Recycling', description: 'Lead a group of Scouts in designing and producing an environmental educational presentation (such as poster, demonstration, activity).')
      ...
      activity = Activity.create(:targets => [environment], title: 'Visit', description: '')
      ...
      activity = Activity.create(:targets => [environment], title: 'Visit', description: 'Plan and visit an organisation devoted to protecting the local, national or international environment.')
      ...
      activity = Activity.create(:targets => [wateractivites], title: 'Seamanship')
      ...
      activity = Activity.create(:targets => [wateractivites], title: 'Motor')
